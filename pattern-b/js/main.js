/* ============================================================
   便利屋ワンズスタイル – Pattern B  main.js
   Dark & Premium design with custom cursor.
   ============================================================ */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (cursorEl && followerEl && window.matchMedia('(hover: hover)').matches) {
    let mouseX = 0;
    let mouseY = 0;
    let followerX = 0;
    let followerY = 0;
    ...
    const hoverTargets = document.querySelectorAll(
      'a, button, .service-card, .service-card--compact, .pillar-card, .area-branch, .testimonial-card'
    );
    ...
    hoverTargets.forEach(target => {
      target.addEventListener('mouseenter', () => {
        ...
        followerEl.style.width = '48px';
        followerEl.style.height = '48px';
      });
      target.addEventListener('mouseleave', () => {
        cursorEl.style.width = '8px';
        cursorEl.style.height = '8px';
        followerEl.style.width = '32px';
